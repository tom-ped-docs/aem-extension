...
{
  chrome.storage.local.get( 'iqosCatalog', ( storage: Storage ) =>
  {
...
{
  chrome.storage.local.get( [ 'iqosVersion', 'iqosUrl' ], ( storage: Storage ) =>
  {
    const CODE: string = storage.iqosUrl.slice( 0, 2 );
...
const unlockAgeGate1 = () =>
{
  ...
  const SELECT_MONTH = document.querySelector( '#months-select' ) as HTMLSelectElement;
  const SELECT_YEAR = document.querySelector( '#years-select' ) as HTMLSelectElement;
  const SPAN_MONTH = document.querySelector( 'span.label-placeholder--month' ) as HTMLSpanElement;
  const SPAN_YEAR = document.querySelector( 'span.label-placeholder--year' ) as HTMLSpanElement;
  ...
  const BUTTON_SUBMIT = document.querySelector( '#nbw-agegate-submit' ) as HTMLButtonElement;
  ...
  const SELECT_MONTH_VEEV = document.querySelector( 'select.birth-month' ) as HTMLSelectElement;
  const SELECT_YEAR_VEEV = document.querySelector( 'select.birth-year' ) as HTMLSelectElement;
  ...
  const BUTTON_SUBMIT_VEEV = document.querySelector( '#agegate-submit' ) as HTMLButtonElement;
