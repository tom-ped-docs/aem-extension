...
const openSignInPage = () => {
    chrome.storage.local.get(['samsungId', 'samsungEmail', 'samsungVersion'], (storage) => {
...
const openEditorPage = () => {
    chrome.storage.local.get(['samsungVersion', 'samsungUrl'], (storage) => {
...
const openQaPage = () => {
    chrome.storage.local.get(['samsungVersion', 'samsungUrl'], (storage) => {
        ...
        else if (storage.samsungVersion === 'v5AemEuShop')
...
const openPublishedPage = () => {
    chrome.storage.local.get('samsungUrl', (storage) => {
...
// ui-popup.mts -> toggleButton
const openTasksPage = () => {
    chrome.storage.local.get('samsungVersion', (storage) => {
...
export { URLS, START_KEYS, END_KEYS, openSignInPage, openEditorPage, openPreviewPage, openQaPage, openPublishedPage, openSitesPage, openAssetsPage, openTasksPage, openWorkflowsPage, openPurgingPage, openPimB2cPage, openPimB2bPage, };
